...
In simple linear regression, there is only one independent variable. The relationship between the dependent variable. The independent variable can be represented by a straight line, hence the term “linear” regression. The equation for a simple linear regression model is:
...
Be advised that a linear relationship does not always exist between two variables, yet somehow they are related. The nature of the relationship just can't be described using a straight line. Linear regression is just one tool of many that can be utilized to describe the reality of your data.
